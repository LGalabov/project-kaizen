...
class KnowledgeService:
    ...
    def __init__(self, knowledge_repo: KnowledgeRepository, scope_repo: ScopeRepository) -> None:
        self.knowledge_repo = knowledge_repo
        self.scope_repo = scope_repo
    
    async def create_knowledge_entry(self, scope: str, content: str, context: str) -> str:
    ...
    async def update_knowledge_entry(
        ...
        await self.knowledge_repo.update(entry_id, content, context, final_scope_id if scope else None)
